# Data sources & assumptions — 2026-2027 Pack 127 Calendar
...
is **image-only**. An OCR'd copy is committed as
`cub 26.27 ideal year of scouting OCR.pdf`; its text layer was extracted to pull
the council/district dates above. A human must re-download, OCR, and update this
PDF each year. The always-current list is at <https://www.nfcscouting.org/calendar>.

## Cub Scout adventures
Source: current Cub Scout program (scouting.org). Each rank = 6 required (incl.
Bobcat, done pack-wide in Aug–Sep) + ≥ 2 electives. Verified placements: Bear
**Whittling** (spring) + **Baloo the Builder**; Webelos **Chef's Knife** (spring);
AOL **Knife Safety** + **Race Time** (via Pinewood). Rank↔grade: Lion K, Tiger 1,
Wolf 2, Bear 3, Webelos 4, AOL 5.
